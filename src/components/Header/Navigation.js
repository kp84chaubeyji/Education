                        ...
                        <div className="header-top-bar-wrap d-sm-flex justify-content-between">
                            ...
                            <div className="header-top-bar-wrap__info">
                                <ul className="header-top-bar-wrap__info-list header-top-bar-wrap__info-list-02">
                                    <li><Link to="tel:+8819906886"><i className="fas fa-phone"></i> <span className="info-text">(+88) 1990 6886</span></Link></li>
                                    <li><Link to="mailto:agency@example.com"><i className="far fa-envelope"></i> <span className="info-text">agency@example.com</span></Link></li>
                                </ul>
                            </div>
                            ...
                            <div className="header-top-bar-wrap__info d-sm-flex">
                                ...
                                <div className="header-top-bar-wrap__language">
                                    <Link className="language-toggle" to="/"><span>English</span></Link>
                    ...
                    <div className="container">
                        ...
                        <div className="header-main-wrapper">
                            ...
                            <div className="header-logo">
                                <Link className="header-logo__logo" to="/"><img src={logo}  alt="Logo" /></Link>
                            </div>
                                ...
                                <div className="header-navigation d-none d-xl-block">
                                    <nav className="menu-primary">
                                        <ul className="menu-primary__container">
                                            <li><Link className="active" to="/"><span>Home</span></Link>
                                    ...
                                    <div className="header-mini-cart">
                                        ...
                                        <ul className="header-mini-cart__product-list ">
                                            <li className="header-mini-cart__item">
                                                ...
                                                <div className="header-mini-cart__thumbnail">
                                                    <Link to="/"><img src="assets/images/product/product-1.png" alt="Product" width="80" height="93" /></Link>
                                                </div>
                                                <div className="header-mini-cart__caption">
                                                    <h3 className="header-mini-cart__name"><Link to="/">Awesome for Websites</Link></h3>
                                            ...
                                            <li className="header-mini-cart__item">
                                                <Link to="/" className="header-mini-cart__close"></Link>
                                                <div className="header-mini-cart__thumbnail">
                                                    <Link to="/"><img src="assets/images/product/product-2.png" alt="Product" width="80" height="93" /></Link>
                                                </div>
                                                <div className="header-mini-cart__caption">
                                                    <h3 className="header-mini-cart__name"> <Link to="/">Awesome for Websites</Link></h3>
                                                    <span className="header-mini-cart__quantity">1 × <strong className="amount">$49</strong><span className="separator">.00</span></span>
                                            ...
                                            <li className="header-mini-cart__item">
                                                <Link to="/" className="header-mini-cart__close"></Link>
                                                <div className="header-mini-cart__thumbnail">
                                                    <Link to="/"><img src="assets/images/product/product-3.png" alt="Product" width="80" height="93" /></Link>
                                                </div>
                                                <div className="header-mini-cart__caption">
                                                    <h3 className="header-mini-cart__name"> <Link to="/">Awesome for Websites</Link></h3>
                                                    <span className="header-mini-cart__quantity">1 × <strong className="amount">$49</strong><span className="separator">.00</span></span>
                                        ...
                                        <div className="header-mini-cart__footer">
                                            ...
                                            <div className="header-mini-cart__btn">
                                                <Link to="/" className="btn btn-primary btn-hover-secondary">View cart</Link>
                                                <Link to="/" className="btn btn-primary btn-hover-secondary">Checkout</Link>
                                            </div>
                                        </div>
